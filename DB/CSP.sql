...
create table users(
	user_id  		int(8) unsigned	not null auto_increment primary key COMMENT '用户ID',
	...
	create_id   int(8) unsigned not null COMMENT '创建人',
	update_id   int(8) unsigned COMMENT '修改人'
);

DROP TABLE IF EXISTS teacher;
create table teacher(
	teacher_id    int(8) unsigned not null auto_increment primary key COMMENT '老师ID',    	
	...
	user_id       int(8) unsigned COMMENT '用户ID',   
...
create table course(
	course_id     int(8) unsigned not null auto_increment primary key COMMENT '课程ID',    
...
create table teacher_course(
	teacher_id int(8) unsigned COMMENT '老师ID' ,                                  
	course_id  int(8) unsigned COMMENT '课程ID' ,                                  
	state      int(1)       not null default 1 COMMENT '状态 1：正常 2：废弃'  ,   
	create_dt     datetime        not null COMMENT '创建日期',  
	upadte_dt     datetime        COMMENT '修改日期',  
	create_id     int(8) unsigned not null COMMENT '创建人',    
...
create table student(
	student_id    int(8) unsigned not null auto_increment primary key COMMENT '学生ID',  
	student_name  CHAR(30)        COMMENT '学生姓名',
	student_code  CHAR(30)        COMMENT '学号',    
	class_id      int(8) unsigned COMMENT '班级ID',  
	phone         CHAR(11)        COMMENT '手机号',  
...
create table class(
	class_id			int(8) unsigned not null auto_increment primary key COMMENT '班级ID',
	...
	teacher_id    int(8) unsigned COMMENT '老师ID 班主任',   
	parent_id    int(8) unsigned COMMENT '家长ID 家长主任',                            
...
create table class_student(
	...
	class_id        int(8) unsigned COMMENT '班级ID',                         
	student_id      int(8) unsigned COMMENT '学生ID',                          
	student_role_id int(8) unsigned COMMENT '学生职务',                       
...
create table class_course(
	class_id    int(8) unsigned COMMENT '班级ID',             
	semester_id int(8) unsigned COMMENT '学期ID',             
	course_id   int(8) unsigned COMMENT '课程ID',             
	teacher_id  int(8) unsigned COMMENT '老师ID',             
	state           int(1)       not null default 1   COMMENT '状态 1:正常 2：无效',    
	create_dt       datetime  not null      COMMENT  '创建日期',              
...
create table parent(
parent_id     int(8) unsigned not null auto_increment primary key COMMENT '家长ID',       
...
create table parent_student(
	parent_id     int(8) unsigned COMMENT '家长ID',  
	student_id    int(8) unsigned COMMENT '学生ID',  
...
create table exam(
  exam_id     int(8) unsigned not null auto_increment primary key COMMENT '考试ID',
...
exam_id     int(8) unsigned COMMENT '考试ID',                
teacher_id  int(8) unsigned COMMENT '老师ID  监考老师',      
state       int(1)          COMMENT '状态    1:正常 2：无效',
create_dt   datetime        COMMENT '创建日期',              
upadte_dt   datetime        COMMENT '修改日期',              
create_id   int(8) unsigned COMMENT '创建人',                
update_id   int(8) unsigned COMMENT '修改人' ,
...
create table score(
	exam_id     int(8) unsigned not null	COMMENT '考试ID',
	student_id    int(8) unsigned COMMENT '学生ID',
...
create table semester(
    semester_id   int(8) unsigned not null auto_increment primary key   COMMENT '学期ID',
...
create table groups(
	group_id    int(8) unsigned  not null auto_increment primary key  COMMENT '群组ID',
	group_name  char(50)          COMMENT '群组名称',
	class_id		int(8) unsigned 	COMMENT '对映班级',
	state       int(1)        not null default 1   COMMENT '状态 1:正常 2：废弃', 
	create_dt   datetime      not null    COMMENT '创建日期',
	upadte_dt   datetime          COMMENT '修改日期',
	create_id   int(8) unsigned  not null COMMENT '创建人',
...
create table group_member(
	group_id    int(8) unsigned  COMMENT '群组ID',                           
	user_id     int(8) unsigned  COMMENT '用户ID', 
...
create table bulletin(
	bulletin_id int(8) unsigned not null auto_increment primary key   COMMENT '公告ID', 
...
create table bulletin_reply(
	bulletin_reply_id int(8) unsigned not null auto_increment primary key   COMMENT '回复ID', 
	bulletin_id       int(8) unsigned  COMMENT '公告ID', 
	content           text       COMMENT '内容', 
...
create table survey(
survey_id       int(8) unsigned not null auto_increment primary key   COMMENT '投票ID',  
level 	int(1) unsigned not null default 1 COMMENT '基础表 。1:群级别2：年级3：学校级4:家长5:老师6:学生',
group_id      int(8) unsigned   COMMENT '群组ID',  
create_id     int(8) unsigned   COMMENT '发起人',  
content  text         COMMENT '内容',    
...
question_id     int(8) unsigned not null auto_increment primary key COMMENT '问题ID',
question_order  int(3) unsigned COMMENT '排序',
survey_id       int(8) unsigned COMMENT '投票ID',
content         text            COMMENT '内容',
...
question_id     int(8) unsigned  COMMENT '问题ID',
